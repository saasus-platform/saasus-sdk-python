...
pip install git+https://github.com/saasus-platform/saasus-sdk-python.git@v1.0.0

# Or install the latest development version
pip install git+https://github.com/saasus-platform/saasus-sdk-python.git
```

For production use, we recommend installing a specific version tag. See [releases](https://github.com/saasus-platform/saasus-sdk-python/releases) for available versions.
...
# Set authentication information from environment variables
# Please set the following in .env file or environment variables:
...
# Create API instance
api_instance = AuthInfoApi(api_client)
