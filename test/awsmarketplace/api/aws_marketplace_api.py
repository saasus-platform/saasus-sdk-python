...
class AwsMarketplaceApi(object):
    ...
    def create_customer(self, create_customer_param : Optional[CreateCustomerParam] = None, **kwargs) -> Customer:  # noqa: E501
        """AWS Marketplaceに連携する顧客情報を新規作成(Create customer information to be linked to AWS Marketplace)  # noqa: E501

        AWS Marketplaceに連携する顧客情報を新規作成します。  Create customer information to be linked to AWS Marketplace.   # noqa: E501
    ...
    def get_catalog_entity_visibility(self, **kwargs) -> CatalogEntityVisibility:  # noqa: E501
        """AWS Marketplaceから商品の公開状況を取得(Obtain product publication status from AWS Marketplace)  # noqa: E501

        AWS Marketplaceから商品の公開状況を取得します。  Retrieve the product's publication status from AWS Marketplace.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_cloud_formation_launch_stack_link(self, **kwargs) -> CloudFormationLaunchStackLink:  # noqa: E501
        """AWS CloudFormationのスタック作成リンクを取得(Get the link to create the AWS CloudFormation stack)  # noqa: E501

        CloudFormationのクイック作成リンクを取得します。  Get the CloudFormation Quick Create link.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_customer(self, customer_identifier : Annotated[StrictStr, Field(..., description="顧客ID")], **kwargs) -> Customer:  # noqa: E501
        """AWS Marketplaceに連携する顧客情報を取得(Get customer information to be linked to AWS Marketplace)  # noqa: E501

        AWS Marketplaceに連携する顧客情報を取得します。  Get customer information to be linked to AWS Marketplace.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param customer_identifier: 顧客ID (required)
    ...
    @validate_arguments
    def get_customer_with_http_info(self, customer_identifier : Annotated[StrictStr, Field(..., description="顧客ID")], **kwargs) -> ApiResponse:  # noqa: E501
        """AWS Marketplaceに連携する顧客情報を取得(Get customer information to be linked to AWS Marketplace)  # noqa: E501
    ...
    def get_customers(self, tenant_ids : Annotated[Optional[conlist(StrictStr)], Field(description="指定したテナントIDの顧客を取得する(Get customers with the specified tenant ID)")] = None, **kwargs) -> Customers:  # noqa: E501
        """AWS Marketplaceに連携する顧客情報の一覧を取得(Get a list of customer information to be linked to AWS Marketplace)  # noqa: E501

        AWS Marketplaceに連携する顧客情報の一覧を取得します。  Get a list of customer information to be linked to AWS Marketplace.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_listing_status(self, **kwargs) -> GetListingStatusResult:  # noqa: E501
        """AWS Marketplaceの出品状況を取得(Get AWS Marketplace Listing Status)  # noqa: E501

        AWS Marketplaceの出品状況を取得します。  Get AWS Marketplace Listing Status.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_plan_by_plan_name(self, plan_name : Annotated[StrictStr, Field(..., description="AWS Marketplace連携プラン名")], **kwargs) -> Plan:  # noqa: E501
        """AWSMarketplaceに連携するプラン情報を取得(Obtain plan information to link to AWS Marketplace)  # noqa: E501

        Marketplaceと連携するプラン情報を取得します。  Obtain plan information to link to AWS Marketplace.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param plan_name: AWS Marketplace連携プラン名 (required)
        :type plan_name: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_arguments
    def get_plan_by_plan_name_with_http_info(self, plan_name : Annotated[StrictStr, Field(..., description="AWS Marketplace連携プラン名")], **kwargs) -> ApiResponse:  # noqa: E501
        """AWSMarketplaceに連携するプラン情報を取得(Obtain plan information to link to AWS Marketplace)  # noqa: E501
    ...
    def get_plans(self, **kwargs) -> Plans:  # noqa: E501
        """AWS Marketplaceに連携するプラン情報を取得(Obtain plan information to link to AWS Marketplace)  # noqa: E501
    ...
    def get_settings(self, **kwargs) -> Settings:  # noqa: E501
        """AWS Marketplaceの設定を取得(Get AWS Marketplace Settings)  # noqa: E501

        AWS Marketplaceの設定を取得します。  Get AWS Marketplace Settings.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def save_plan(self, save_plan_param : Optional[SavePlanParam] = None, **kwargs) -> None:  # noqa: E501
        """AWS Marketplaceに連携するプラン情報を登録(Save plan information to be linked to AWSMarketplace)  # noqa: E501

        AWSMarketplaceに連携するプラン情報を登録します。  Save plan information to be linked to AWSMarketplace.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def sync_customer(self, customer_identifier : Annotated[StrictStr, Field(..., description="顧客ID")], **kwargs) -> None:  # noqa: E501
        """AWS Marketplaceの顧客情報をSaaSusに同期します(Sync AWS Marketplace customer information to SaaSus)  # noqa: E501
    ...
    @validate_arguments
    def sync_customer_with_http_info(self, customer_identifier : Annotated[StrictStr, Field(..., description="顧客ID")], **kwargs) -> ApiResponse:  # noqa: E501
        """AWS Marketplaceの顧客情報をSaaSusに同期します(Sync AWS Marketplace customer information to SaaSus)  # noqa: E501
    ...
    def update_listing_status(self, update_listing_status_param : Optional[UpdateListingStatusParam] = None, **kwargs) -> None:  # noqa: E501
        """AWS Marketplaceの出品状況を更新(Update AWS Marketplace Listing Status)  # noqa: E501

        AWS Marketplaceの出品状況を更新します。  Update AWS Marketplace Listing Status.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_settings(self, update_settings_param : Optional[UpdateSettingsParam] = None, **kwargs) -> None:  # noqa: E501
        """AWS Marketplaceの設定を更新(Update AWS Marketplace Settings)  # noqa: E501

        AWS Marketplaceの設定を更新します。  Update AWS Marketplace Settings.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def verify_registration_token(self, verify_registration_token_param : Optional[VerifyRegistrationTokenParam] = None, **kwargs) -> None:  # noqa: E501
        """Registration Tokenを検証(Verify Registration Token)  # noqa: E501

        Registration Tokenを検証します。  Verify Registration Token.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
