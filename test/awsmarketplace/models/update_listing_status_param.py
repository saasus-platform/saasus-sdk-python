...
class UpdateListingStatusParam(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateListingStatusParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateListingStatusParam:
        """Create an instance of UpdateListingStatusParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateListingStatusParam.parse_obj(obj)

        _obj = UpdateListingStatusParam.parse_obj({
