...
class UpdateCustomizePageSettingsParam(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateCustomizePageSettingsParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateCustomizePageSettingsParam:
        """Create an instance of UpdateCustomizePageSettingsParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateCustomizePageSettingsParam.parse_obj(obj)

        _obj = UpdateCustomizePageSettingsParam.parse_obj({
            "title": obj.get("title"),
