...
class SignUpWithAwsMarketplaceParam(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignUpWithAwsMarketplaceParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignUpWithAwsMarketplaceParam:
        """Create an instance of SignUpWithAwsMarketplaceParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignUpWithAwsMarketplaceParam.parse_obj(obj)

        _obj = SignUpWithAwsMarketplaceParam.parse_obj({
            "email": obj.get("email"),
