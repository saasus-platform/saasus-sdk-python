...
class MfaPreference(BaseModel):
    ...
    MfaPreference
    """
    enabled: StrictBool = Field(..., description="MFAを有効にするか否か(enable MFA)")
    method: Optional[StrictStr] = Field(None, description="MFAの方法(enabledがtrueの場合は必須)(MFA method (required if enabled is true))")
