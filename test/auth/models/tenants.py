...
class Tenants(BaseModel):
    ...
    Tenant Info
    """
    tenants: Annotated[List[Tenant], Field()] = Field(...)
    __properties = ["tenants"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Tenants:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Tenants:
        """Create an instance of Tenants from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Tenants.parse_obj(obj)

        _obj = Tenants.parse_obj({
