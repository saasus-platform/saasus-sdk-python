...
class UpdateNotificationMessagesParam(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sign_up", "create_user", "resend_code", "forgot_password", "update_user_attribute", "verify_user_attribute", "authentication_mfa", "invite_tenant_user", "verify_external_user"]
