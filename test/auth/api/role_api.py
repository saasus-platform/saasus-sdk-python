...
class RoleApi(object):
    ...
    def create_role(self, body : Optional[Role] = None, **kwargs) -> Role:  # noqa: E501
        ...
        Create a role. By granting users the roles created here, it becomes easier to implement role-based authorization on the SaaS side. In addition, even the same user can have different roles for each tenant/environment to which they belong.   # noqa: E501
    ...
    @validate_arguments
    def delete_role(self, role_name : Annotated[StrictStr, Field(..., description="Role name")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_role_with_http_info(self, role_name : Annotated[StrictStr, Field(..., description="Role name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete Role  # noqa: E501
    ...
    def get_roles(self, **kwargs) -> Roles:  # noqa: E501
        ...
        Get registered roles list. Granting users the roles defined here makes it easy to implement role-based authorization on the SaaS side. In addition, even the same user can have different roles for each tenant/environment to which they belong.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_role(self, role_name : Annotated[StrictStr, Field(..., description="Role name")], update_role_param : Optional[UpdateRoleParam] = None, **kwargs) -> None:  # noqa: E501
        """Update Role  # noqa: E501

        Update role display name.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_role(role_name, update_role_param, async_req=True)
        >>> result = thread.get()

        :param role_name: Role name (required)
        :type role_name: str
        :param update_role_param:
        :type update_role_param: UpdateRoleParam
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        return self.update_role_with_http_info(role_name, update_role_param, **kwargs)  # noqa: E501

    @validate_arguments
    def update_role_with_http_info(self, role_name : Annotated[StrictStr, Field(..., description="Role name")], update_role_param : Optional[UpdateRoleParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update Role  # noqa: E501
        ...
        >>> thread = api.update_role_with_http_info(role_name, update_role_param, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['update_role_param'] is not None:
            _body_params = _params['update_role_param']
