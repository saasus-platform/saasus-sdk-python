...
class SaasUserApi(object):
    ...
    @validate_arguments
    def confirm_email_update(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], confirm_email_update_param : Optional[ConfirmEmailUpdateParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def confirm_email_update_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], confirm_email_update_param : Optional[ConfirmEmailUpdateParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのメールアドレス変更確認(Confirm User Email Update)  # noqa: E501
    ...
    @validate_arguments
    def create_secret_code(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], create_secret_code_param : Optional[CreateSecretCodeParam] = None, **kwargs) -> SoftwareTokenSecretCode:  # noqa: E501
    ...
    @validate_arguments
    def create_secret_code_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], create_secret_code_param : Optional[CreateSecretCodeParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """認証アプリケーション登録用のシークレットコードを作成(Creates secret code for authentication application registration)  # noqa: E501
    ...
    @validate_arguments
    def delete_saas_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_saas_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を削除(Delete User)  # noqa: E501
    ...
    @validate_arguments
    def get_saas_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> SaasUser:  # noqa: E501
    ...
    @validate_arguments
    def get_saas_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を取得(Get User)  # noqa: E501
    ...
    @validate_arguments
    def get_user_mfa_preference(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> MfaPreference:  # noqa: E501
    ...
    @validate_arguments
    def get_user_mfa_preference_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのMFA設定を取得(Get User's MFA Settings)  # noqa: E501
    ...
    @validate_arguments
    def request_email_update(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], request_email_update_param : Optional[RequestEmailUpdateParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def request_email_update_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], request_email_update_param : Optional[RequestEmailUpdateParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのメールアドレス変更要求(Request User Email Update)  # noqa: E501
    ...
    @validate_arguments
    def unlink_provider(self, provider_name : StrictStr, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def unlink_provider_with_http_info(self, provider_name : StrictStr, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """外部IDプロバイダの連携解除(Unlink external identity providers)  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_email(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_saas_user_email_param : Optional[UpdateSaasUserEmailParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_email_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_saas_user_email_param : Optional[UpdateSaasUserEmailParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """メールアドレスを変更(Change Email)  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_password(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_saas_user_password_param : Optional[UpdateSaasUserPasswordParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_password_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_saas_user_password_param : Optional[UpdateSaasUserPasswordParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """パスワードを変更(Change Password)  # noqa: E501
    ...
    @validate_arguments
    def update_software_token(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_software_token_param : Optional[UpdateSoftwareTokenParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_software_token_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_software_token_param : Optional[UpdateSoftwareTokenParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """認証アプリケーションを登録(Register Authentication Application)  # noqa: E501
    ...
    @validate_arguments
    def update_user_mfa_preference(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], body : Optional[MfaPreference] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_user_mfa_preference_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], body : Optional[MfaPreference] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのMFA設定を更新(Update User's MFA Settings)  # noqa: E501
