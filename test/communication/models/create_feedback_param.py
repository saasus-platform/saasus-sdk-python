...
class CreateFeedbackParam(BaseModel):
    ...
    __properties = ["feedback_title", "feedback_description", "user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFeedbackParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFeedbackParam:
        """Create an instance of CreateFeedbackParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFeedbackParam.parse_obj(obj)

        _obj = CreateFeedbackParam.parse_obj({
