...
class UpdateFeedbackStatusParam(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateFeedbackStatusParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateFeedbackStatusParam:
        """Create an instance of UpdateFeedbackStatusParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateFeedbackStatusParam.parse_obj(obj)

        _obj = UpdateFeedbackStatusParam.parse_obj({
