...
class PricingTieredUsageUnit(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PricingTieredUsageUnit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PricingTieredUsageUnit:
        """Create an instance of PricingTieredUsageUnit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PricingTieredUsageUnit.parse_obj(obj)

        _obj = PricingTieredUsageUnit.parse_obj({
