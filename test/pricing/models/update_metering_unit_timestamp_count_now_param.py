...
class UpdateMeteringUnitTimestampCountNowParam(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMeteringUnitTimestampCountNowParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMeteringUnitTimestampCountNowParam:
        """Create an instance of UpdateMeteringUnitTimestampCountNowParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMeteringUnitTimestampCountNowParam.parse_obj(obj)

        _obj = UpdateMeteringUnitTimestampCountNowParam.parse_obj({
