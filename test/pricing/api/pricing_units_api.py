...
class PricingUnitsApi:
    ...
    def create_pricing_unit(
        ...
        _param = self._create_pricing_unit_serialize(
            body=body,
    ...
    @validate_call
    def create_pricing_unit_with_http_info(
        self,
        body: Optional[PricingUnitForSave] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_pricing_unit_without_preload_content(
        self,
        body: Optional[PricingUnitForSave] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_pricing_unit_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def delete_pricing_unit(
        ...
        _param = self._delete_pricing_unit_serialize(
    ...
    def _delete_pricing_unit_serialize(
        self,
        pricing_unit_id,
        _request_auth,
        _content_type,
        ...
        # process the path parameters
        if pricing_unit_id is not None:
            _path_params['pricing_unit_id'] = pricing_unit_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/units/{pricing_unit_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_pricing_unit(
        ...
        _param = self._get_pricing_unit_serialize(
            pricing_unit_id=pricing_unit_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_pricing_unit_serialize(
        self,
        pricing_unit_id,
        _request_auth,
        _content_type,
    ...
    def get_pricing_units(
        ...
        _param = self._get_pricing_units_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_pricing_units_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_pricing_units_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_pricing_units_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def update_pricing_unit(
        ...
        _param = self._update_pricing_unit_serialize(
            pricing_unit_id=pricing_unit_id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _update_pricing_unit_serialize(
        self,
        pricing_unit_id,
        body,
        _request_auth,
