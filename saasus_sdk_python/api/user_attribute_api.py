...
class UserAttributeApi(object):
    ...
    @validate_arguments
    def delete_user_attribute(self, attribute_name : Annotated[StrictStr, Field(..., description="属性名(Attribute Name)")], **kwargs) -> None:  # noqa: E501
        """ユーザー属性の削除(Delete User Attribute)  # noqa: E501

        SaaSus Platform にて保持するユーザーの追加属性を削除します。  Delete user attributes kept on the SaaSus Platform.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_user_attribute_with_http_info(self, attribute_name : Annotated[StrictStr, Field(..., description="属性名(Attribute Name)")], **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー属性の削除(Delete User Attribute)  # noqa: E501
