...
class EnvApi(object):
    ...
    @validate_arguments
    def delete_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], **kwargs) -> None:  # noqa: E501
        """環境情報を削除(Delete Env Info)  # noqa: E501

        環境情報を削除します。  Delete env info.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を削除(Delete Env Info)  # noqa: E501
    ...
    @validate_arguments
    def get_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], **kwargs) -> Env:  # noqa: E501
    ...
    @validate_arguments
    def get_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を取得(Get Env Details)  # noqa: E501
    ...
    @validate_arguments
    def update_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], update_env_param : Optional[UpdateEnvParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], update_env_param : Optional[UpdateEnvParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を更新(Update Env Info)  # noqa: E501
