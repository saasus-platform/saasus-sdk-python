...
class TenantUserApi(object):
    ...
    @validate_arguments
    def create_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], create_tenant_user_param : Optional[CreateTenantUserParam] = None, **kwargs) -> User:  # noqa: E501
    ...
    @validate_arguments
    def create_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], create_tenant_user_param : Optional[CreateTenantUserParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントにユーザーを作成(Create Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def create_tenant_user_roles(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], create_tenant_user_roles_param : Optional[CreateTenantUserRolesParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー情報を削除(Delete Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user_role(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user_role_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")], role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")], **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザーから役割(ロール)を削除(Remove Role From Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def get_all_tenant_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> Users:  # noqa: E501
    ...
    @validate_arguments
    def get_all_tenant_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を取得(Get User Info)  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> User:  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー情報を取得(Get Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_users(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], **kwargs) -> Users:  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_users_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー一覧を取得(Get Tenant Users)  # noqa: E501
    ...
    @validate_arguments
    def update_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_tenant_user_param : Optional[UpdateTenantUserParam] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def update_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")], user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")], update_tenant_user_param : Optional[UpdateTenantUserParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー属性情報を更新(Update Tenant User Attribute)  # noqa: E501
