...
class PricingUnitsApi(object):
    ...
    def create_pricing_unit(self, body : Optional[PricingUnitForSave] = None, **kwargs) -> PricingUnit:  # noqa: E501
        """プライシングユニットを作成(Create Pricing Unit)  # noqa: E501

        プライシングユニットを作成します。  Create a pricing unit.   # noqa: E501
    ...
    @validate_arguments
    def delete_pricing_unit(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, **kwargs) -> None:  # noqa: E501
        """プライシングユニットを削除(Delete Pricing Unit)  # noqa: E501

        プライシングユニットを削除します。  Delete a pricing unit.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param pricing_unit_id: ユニットID(unit id) (required)
    ...
    @validate_arguments
    def delete_pricing_unit_with_http_info(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """プライシングユニットを削除(Delete Pricing Unit)  # noqa: E501
    ...
    @validate_arguments
    def get_pricing_unit(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, **kwargs) -> PricingUnit:  # noqa: E501
        """プライシングユニットを取得(Get Pricing Unit)  # noqa: E501

        プライシングユニットを取得します。  Get a pricing unit.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_pricing_unit_with_http_info(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """プライシングユニットを取得(Get Pricing Unit)  # noqa: E501
    ...
    def get_pricing_units(self, **kwargs) -> PricingUnits:  # noqa: E501
        """プライシングユニットの一覧を取得(Get Pricing Units)  # noqa: E501
    ...
    @validate_arguments
    def update_pricing_unit(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, body : Optional[PricingUnitForSave] = None, **kwargs) -> None:  # noqa: E501
        """プライシングユニットを更新(Update Pricing Unit)  # noqa: E501

        プライシングユニット情報を更新します。  Update pricing unit.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_pricing_unit_with_http_info(self, pricing_unit_id : Annotated[StrictStr, Field(..., description="ユニットID(unit id)")] = None, body : Optional[PricingUnitForSave] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """プライシングユニットを更新(Update Pricing Unit)  # noqa: E501
