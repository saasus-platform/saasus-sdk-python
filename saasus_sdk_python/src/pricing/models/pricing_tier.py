...
class PricingTier(BaseModel):
    ...
    PricingTier
    """
    up_to: StrictInt = Field(..., description="上限(upper limit)")
    unit_amount: StrictInt = Field(..., description="単位金額(amount per unit)")
    flat_amount: StrictInt = Field(..., description="固定金額(fixed Amount)")
    inf: StrictBool = Field(..., description="inf")
