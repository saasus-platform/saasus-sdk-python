...
class PricingMenus(BaseModel):
    """
    PricingMenus
    """
    pricing_menus: Annotated[List[PricingMenu], Field()] = Field(...)
    __properties = ["pricing_menus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PricingMenus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PricingMenus:
        """Create an instance of PricingMenus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PricingMenus.parse_obj(obj)

        _obj = PricingMenus.parse_obj({
