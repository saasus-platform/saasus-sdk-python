...
class CreateFeedbackCommentParam(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFeedbackCommentParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFeedbackCommentParam:
