...
class TenantDetail(BaseModel):
    ...
    current_plan_period_start: Optional[StrictInt] = Field(None, description="current plan period start")
    current_plan_period_end: Optional[StrictInt] = Field(None, description="current plan period end")
