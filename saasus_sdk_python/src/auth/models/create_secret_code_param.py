...
class CreateSecretCodeParam(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSecretCodeParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSecretCodeParam:
        """Create an instance of CreateSecretCodeParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSecretCodeParam.parse_obj(obj)

        _obj = CreateSecretCodeParam.parse_obj({
