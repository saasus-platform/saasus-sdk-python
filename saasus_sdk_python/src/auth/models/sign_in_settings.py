...
class SignInSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["password_policy", "device_configuration", "mfa_configuration", "recaptcha_props", "account_verification", "self_regist", "identity_provider_configuration"]
