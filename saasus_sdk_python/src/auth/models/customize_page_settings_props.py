...
class CustomizePageSettingsProps(BaseModel):
    """
    ...
    __properties = ["title", "terms_of_service_url", "privacy_policy_url", "google_tag_manager_container_id", "is_sign_in_id_enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomizePageSettingsProps:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomizePageSettingsProps:
        """Create an instance of CustomizePageSettingsProps from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomizePageSettingsProps.parse_obj(obj)

        _obj = CustomizePageSettingsProps.parse_obj({
            "title": obj.get("title"),
