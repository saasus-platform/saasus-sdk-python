...
class IdentityProviderProps(BaseModel):
    ...
    application_secret: StrictStr
    approval_scope: StrictStr
    is_button_hidden: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["application_id", "application_secret", "approval_scope", "is_button_hidden"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "is_button_hidden": obj.get("is_button_hidden")
        })
        return _obj
