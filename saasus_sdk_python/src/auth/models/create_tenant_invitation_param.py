...
class CreateTenantInvitationParam(BaseModel):
    ...
    """
    email: StrictStr = Field(..., description="招待するユーザーのメールアドレス(email address of the user to be invited)")
    access_token: StrictStr = Field(..., description="招待を作成するユーザーのアクセストークン(access token of the user who creates an invitation)")
