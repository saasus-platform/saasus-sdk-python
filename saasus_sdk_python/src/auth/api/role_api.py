...
class RoleApi(object):
    ...
    @validate_arguments
    def delete_role(self, role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_role_with_http_info(self, role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """役割(ロール)を削除(Delete Role)  # noqa: E501
