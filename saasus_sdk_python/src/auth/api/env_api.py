...
class EnvApi(object):
    ...
    def create_env(self, body : Optional[Env] = None, **kwargs) -> Env:  # noqa: E501
        ...
        環境情報を作成します。 連携のテストや開発用環境や実際の運用で利用する環境など複数の環境を定義することができます。  Create environment information. Multiple environments can be defined, such as an environment for testing linkage, an environment for development, and an environment for actual operation.   # noqa: E501
    ...
    @validate_arguments
    def delete_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, **kwargs) -> None:  # noqa: E501
        """環境情報を削除(Delete Env Info)  # noqa: E501

        環境情報を削除します。idが3の環境は削除できません。  Delete env info. Env with id 3 cannot be deleted.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を削除(Delete Env Info)  # noqa: E501
    ...
    @validate_arguments
    def get_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, **kwargs) -> Env:  # noqa: E501
        """環境情報を取得(Get Env Details)  # noqa: E501

        環境情報の詳細を取得します。  Get environment details.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を取得(Get Env Details)  # noqa: E501
    ...
    def get_envs(self, **kwargs) -> Envs:  # noqa: E501
        ...
        登録されている環境情報を取得します。 連携のテストや開発用環境や実際の運用で利用する環境など複数の環境を定義することができます。  Get registered environment information. Multiple environments can be defined, such as an environment for testing linkage, an environment for development, and an environment for actual operation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_env(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, update_env_param : Optional[UpdateEnvParam] = None, **kwargs) -> None:  # noqa: E501
        """環境情報を更新(Update Env Info)  # noqa: E501

        環境情報を更新します。  Update env info.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_env_with_http_info(self, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, update_env_param : Optional[UpdateEnvParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """環境情報を更新(Update Env Info)  # noqa: E501
