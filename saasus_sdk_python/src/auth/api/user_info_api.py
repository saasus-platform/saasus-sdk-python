...
class UserInfoApi(object):
    ...
    @validate_arguments
    def get_user_info(self, token : Annotated[StrictStr, Field(..., description="IDトークン(ID Token)")] = None, **kwargs) -> UserInfo:  # noqa: E501
    ...
    @validate_arguments
    def get_user_info_with_http_info(self, token : Annotated[StrictStr, Field(..., description="IDトークン(ID Token)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報取得(Get User Info)  # noqa: E501
