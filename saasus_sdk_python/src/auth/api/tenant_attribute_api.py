...
class TenantAttributeApi(object):
    ...
    def create_tenant_attribute(self, body : Optional[Attribute] = None, **kwargs) -> Attribute:  # noqa: E501
        """Create Tenant Attribute  # noqa: E501

        Register additional tenant attributes to be managed by SaaSus Platform. For example, tenant name, memo, etc., then get the attributes from SaaS using the SaaSus SDK/API.   # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_attribute(self, attribute_name : Annotated[StrictStr, Field(..., description="Attribute Name")], **kwargs) -> None:  # noqa: E501
        """Delete Tenant Attribute  # noqa: E501

        Deletes tenant attributes managed by SaaSus Platform.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_tenant_attribute_with_http_info(self, attribute_name : Annotated[StrictStr, Field(..., description="Attribute Name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete Tenant Attribute  # noqa: E501
    ...
    def get_tenant_attributes(self, **kwargs) -> TenantAttributes:  # noqa: E501
        """Get Tenant Attributes  # noqa: E501

        Get definitions for additional tenant attributes managed by the SaaSus Platform. For example, tenant name, memo, etc., then get the attributes from SaaS using the SaaSus SDK/API.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
