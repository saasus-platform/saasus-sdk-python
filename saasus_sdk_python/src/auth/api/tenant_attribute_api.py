...
class TenantAttributeApi(object):
    ...
    @validate_arguments
    def delete_tenant_attribute(self, attribute_name : Annotated[StrictStr, Field(..., description="属性名(Attribute Name)")] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_attribute_with_http_info(self, attribute_name : Annotated[StrictStr, Field(..., description="属性名(Attribute Name)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナント属性の削除(Delete Tenant Attribute)  # noqa: E501
