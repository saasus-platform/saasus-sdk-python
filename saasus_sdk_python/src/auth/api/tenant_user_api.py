...
class TenantUserApi(object):
    ...
    @validate_arguments
    def create_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, create_tenant_user_param : Optional[CreateTenantUserParam] = None, **kwargs) -> User:  # noqa: E501
        """テナントにユーザーを作成(Create Tenant User)  # noqa: E501

        テナントにユーザーを作成します。 attributesを空のオブジェクトにした場合、追加属性は空で作成されます。  Create a tenant user. If attributes is empty, the additional attributes will be created empty.   # noqa: E501
    ...
    @validate_arguments
    def create_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, create_tenant_user_param : Optional[CreateTenantUserParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントにユーザーを作成(Create Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def create_tenant_user_roles(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, create_tenant_user_roles_param : Optional[CreateTenantUserRolesParam] = None, **kwargs) -> None:  # noqa: E501
        """テナントのユーザー情報に役割(ロール)を作成(Create Tenant User Role)  # noqa: E501

        テナントのユーザーに役割(ロール)を作成します。  Create roles on tenant users.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :type user_id: str
        :param env_id: 環境ID(Env ID) (required)
        :type env_id: int
    ...
    @validate_arguments
    def create_tenant_user_roles_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, create_tenant_user_roles_param : Optional[CreateTenantUserRolesParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー情報に役割(ロール)を作成(Create Tenant User Role)  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> None:  # noqa: E501
        """テナントのユーザー情報を削除(Delete Tenant User)  # noqa: E501

        テナントからユーザーを削除します。  Delete a user from your tenant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー情報を削除(Delete Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def delete_tenant_user_role(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")] = None, **kwargs) -> None:  # noqa: E501
        """テナントのユーザーから役割(ロール)を削除(Remove Role From Tenant User)  # noqa: E501

        テナントのユーザーから役割(ロール)を削除します。  Remove a role from a tenant user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_tenant_user_role_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, env_id : Annotated[StrictInt, Field(..., description="環境ID(Env ID)")] = None, role_name : Annotated[StrictStr, Field(..., description="役割(ロール)名(role name)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザーから役割(ロール)を削除(Remove Role From Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def get_all_tenant_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> Users:  # noqa: E501
        """ユーザー情報を取得(Get User Info)  # noqa: E501

        ユーザーIDからテナントに所属しているユーザー情報を取得します。 複数テナントに所属している場合は別のオブジェクトとして返却されます。  Get information on user belonging to the tenant from the user ID. If the user belongs to multiple tenants, it will be returned as another object.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_all_tenant_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を取得(Get User Info)  # noqa: E501
    ...
    def get_all_tenant_users(self, **kwargs) -> Users:  # noqa: E501
        ...
        テナントに所属しているユーザー全件を取得します。 複数テナントに所属する同一ユーザーは別のオブジェクトとして返却されます。 idは一意ではありません。  Get all users belonging to the tenant. The same user belonging to multiple tenants will be returned as a different object. Id is not unique.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> User:  # noqa: E501
        """テナントのユーザー情報を取得(Get Tenant User)  # noqa: E501

        テナントのユーザーをIDから一件取得します。  Get one tenant user by specific ID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー情報を取得(Get Tenant User)  # noqa: E501
    ...
    @validate_arguments
    def get_tenant_users(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, **kwargs) -> Users:  # noqa: E501
        """テナントのユーザー一覧を取得(Get Tenant Users)  # noqa: E501

        テナントに所属するユーザーを全件取得します。 idは一意です。  Get all the users belonging to the tenant. Id is unique.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_tenant_users_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー一覧を取得(Get Tenant Users)  # noqa: E501
    ...
    @validate_arguments
    def update_tenant_user(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_tenant_user_param : Optional[UpdateTenantUserParam] = None, **kwargs) -> None:  # noqa: E501
        """テナントのユーザー属性情報を更新(Update Tenant User Attribute)  # noqa: E501

        テナントのユーザー属性情報を更新します。  Update tenant user attributes.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_tenant_user_with_http_info(self, tenant_id : Annotated[StrictStr, Field(..., description="テナントID(Tenant ID)")] = None, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_tenant_user_param : Optional[UpdateTenantUserParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """テナントのユーザー属性情報を更新(Update Tenant User Attribute)  # noqa: E501
