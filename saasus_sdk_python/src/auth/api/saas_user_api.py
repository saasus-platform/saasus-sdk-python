...
class SaasUserApi(object):
    ...
    @validate_arguments
    def confirm_email_update(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, confirm_email_update_param : Optional[ConfirmEmailUpdateParam] = None, **kwargs) -> None:  # noqa: E501
        """ユーザーのメールアドレス変更確認(Confirm User Email Update)  # noqa: E501

        ユーザーのメールアドレス変更確認のためにコードを検証します。 ユーザーのアクセストークンが必要です。  Verify the code to confirm the user's email address update. Requires the user's access token.   # noqa: E501
        ...
        :param user_id: ユーザーID(User ID) (required)
        :type user_id: str
    ...
    @validate_arguments
    def confirm_email_update_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, confirm_email_update_param : Optional[ConfirmEmailUpdateParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのメールアドレス変更確認(Confirm User Email Update)  # noqa: E501
    ...
    def confirm_external_user_link(self, confirm_external_user_link_param : Optional[ConfirmExternalUserLinkParam] = None, **kwargs) -> None:  # noqa: E501
        """外部アカウントのユーザーの連携確認(Confirm External User Account Link)  # noqa: E501

        外部アカウントのユーザー連携確認のためにコードを検証します。  Verify the code for external account user link confirmation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def confirm_sign_up_with_aws_marketplace(self, confirm_sign_up_with_aws_marketplace_param : Optional[ConfirmSignUpWithAwsMarketplaceParam] = None, **kwargs) -> Tenant:  # noqa: E501
        ...
        AWS Marketplaceと連携したユーザー新規登録を確定します。AWS Marketplaceと連携したテナントを新規作成します。 Registration Tokenが有効でない場合はエラーを返却します。  Confirm a new use registeration linked to AWS Marketplace. Create a new tenant linked to AWS Marketplace. If the Registration Token is not valid, an error is returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_saas_user(self, create_saas_user_param : Optional[CreateSaasUserParam] = None, **kwargs) -> SaasUser:  # noqa: E501
        ...
        SaaSにユーザーを作成します。  Create SaaS User.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def create_secret_code(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, create_secret_code_param : Optional[CreateSecretCodeParam] = None, **kwargs) -> SoftwareTokenSecretCode:  # noqa: E501
        """認証アプリケーション登録用のシークレットコードを作成(Creates secret code for authentication application registration)  # noqa: E501

        認証アプリケーション登録用のシークレットコードを作成します。  Create a secret code for authentication application registration.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def create_secret_code_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, create_secret_code_param : Optional[CreateSecretCodeParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """認証アプリケーション登録用のシークレットコードを作成(Creates secret code for authentication application registration)  # noqa: E501
    ...
    @validate_arguments
    def delete_saas_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> None:  # noqa: E501
        """ユーザー情報を削除(Delete User)  # noqa: E501

        ユーザーIDを元に一致するユーザーをテナントからすべて削除し、SaaSからも削除します。  Delete all users with matching user ID from the tenant and SaaS.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def delete_saas_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を削除(Delete User)  # noqa: E501
    ...
    @validate_arguments
    def get_saas_user(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> SaasUser:  # noqa: E501
        """ユーザー情報を取得(Get User)  # noqa: E501

        ユーザーIDからユーザー情報を取得します。  Get user information based on user ID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_saas_user_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザー情報を取得(Get User)  # noqa: E501
    ...
    def get_saas_users(self, **kwargs) -> SaasUsers:  # noqa: E501
        ...
        SaaSのユーザー全件を取得します。  Get all SaaS users.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_user_mfa_preference(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> MfaPreference:  # noqa: E501
        """ユーザーのMFA設定を取得(Get User's MFA Settings)  # noqa: E501

        ユーザーのMFA設定を取得します。  Get the user's MFA settings.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_user_mfa_preference_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのMFA設定を取得(Get User's MFA Settings)  # noqa: E501
    ...
    def link_aws_marketplace(self, link_aws_marketplace_param : Optional[LinkAwsMarketplaceParam] = None, **kwargs) -> None:  # noqa: E501
        ...
        AWS Marketplaceと既存のテナントを連携します。 Registration Tokenが有効でない場合はエラーを返却します。  Link an existing tenant with AWS Marketplace. If the Registration Token is not valid, an error is returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def request_email_update(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, request_email_update_param : Optional[RequestEmailUpdateParam] = None, **kwargs) -> None:  # noqa: E501
        """ユーザーのメールアドレス変更要求(Request User Email Update)  # noqa: E501

        ユーザーのメールアドレス変更を要求します。 要求されたメールアドレスに対して検証コードを送信します。 ユーザーのアクセストークンが必要です。 検証コードの有効期限は24時間です。  Request to update the user's email address. Sends a verification code to the requested email address. Requires the user's access token. The verification code is valid for 24 hours.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def request_email_update_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, request_email_update_param : Optional[RequestEmailUpdateParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのメールアドレス変更要求(Request User Email Update)  # noqa: E501
    ...
    def request_external_user_link(self, request_external_user_link_param : Optional[RequestExternalUserLinkParam] = None, **kwargs) -> None:  # noqa: E501
        """外部アカウントのユーザー連携要求(Request External User Account Link)  # noqa: E501

        外部アカウントのユーザー連携を要求します。 アクセストークンから連携するユーザーのメールアドレスを取得し、そのメールアドレスに対して検証コードを送信します。 検証コードの有効期限は24時間です。  Request to link an external account user. Get the email address of the user to be linked from the access token and send a verification code to that email address. The verification code is valid for 24 hours.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def resend_sign_up_confirmation_email(self, resend_sign_up_confirmation_email_param : Optional[ResendSignUpConfirmationEmailParam] = None, **kwargs) -> None:  # noqa: E501
        ...
        新規登録時の仮パスワードを再送信します。  Resend temporary password for the new registered user.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sign_up(self, sign_up_param : Optional[SignUpParam] = None, **kwargs) -> SaasUser:  # noqa: E501
        ...
        ユーザーを新規登録します。登録されたメールアドレスに対して仮パスワードを送信します。  Register a new user. A temporary password will be sent to the registered email.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sign_up_with_aws_marketplace(self, sign_up_with_aws_marketplace_param : Optional[SignUpWithAwsMarketplaceParam] = None, **kwargs) -> SaasUser:  # noqa: E501
        ...
        AWS Marketplaceと連携したユーザーを新規登録します。登録されたメールアドレスに対して仮パスワードを送信します。 Registration Tokenが有効でない場合はエラーを返却します。  Register a new user linked to AWS Marketplace. A temporary password will be sent to the registered email. If the Registration Token is not valid, an error is returned.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def unlink_provider(self, provider_name : StrictStr, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> None:  # noqa: E501
        """外部IDプロバイダの連携解除(Unlink external identity providers)  # noqa: E501

        外部IDプロバイダの連携を解除します。  Unlink external identity providers.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def unlink_provider_with_http_info(self, provider_name : StrictStr, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """外部IDプロバイダの連携解除(Unlink external identity providers)  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_email(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_saas_user_email_param : Optional[UpdateSaasUserEmailParam] = None, **kwargs) -> None:  # noqa: E501
        """メールアドレスを変更(Change Email)  # noqa: E501

        ユーザーのメールアドレスを変更します。  Change user's email.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_saas_user_email_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_saas_user_email_param : Optional[UpdateSaasUserEmailParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """メールアドレスを変更(Change Email)  # noqa: E501
    ...
    @validate_arguments
    def update_saas_user_password(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_saas_user_password_param : Optional[UpdateSaasUserPasswordParam] = None, **kwargs) -> None:  # noqa: E501
        """パスワードを変更(Change Password)  # noqa: E501

        ユーザーのログインパスワードを変更します。  Change user's login password.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_saas_user_password_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_saas_user_password_param : Optional[UpdateSaasUserPasswordParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """パスワードを変更(Change Password)  # noqa: E501
    ...
    @validate_arguments
    def update_software_token(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_software_token_param : Optional[UpdateSoftwareTokenParam] = None, **kwargs) -> None:  # noqa: E501
        """認証アプリケーションを登録(Register Authentication Application)  # noqa: E501

        認証アプリケーションを登録します。  Register an authentication application.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_software_token_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, update_software_token_param : Optional[UpdateSoftwareTokenParam] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """認証アプリケーションを登録(Register Authentication Application)  # noqa: E501
    ...
    @validate_arguments
    def update_user_mfa_preference(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, body : Optional[MfaPreference] = None, **kwargs) -> None:  # noqa: E501
        """ユーザーのMFA設定を更新(Update User's MFA Settings)  # noqa: E501

        ユーザーのMFA設定を更新します。  Update user's MFA settings.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def update_user_mfa_preference_with_http_info(self, user_id : Annotated[StrictStr, Field(..., description="ユーザーID(User ID)")] = None, body : Optional[MfaPreference] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """ユーザーのMFA設定を更新(Update User's MFA Settings)  # noqa: E501
