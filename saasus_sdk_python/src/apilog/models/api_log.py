...
class ApiLog(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trace_id", "api_log_id", "created_at", "created_date", "ttl", "request_method", "saas_id", "api_key", "response_status", "request_uri", "remote_address", "referer", "request_body", "response_body"]
