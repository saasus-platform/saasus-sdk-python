...
class UpdateNotificationMessagesParam(BaseModel):
    """
    UpdateNotificationMessagesParam
    """
    sign_up: Optional[MessageTemplate] = None
    create_user: Optional[MessageTemplate] = None
    resend_code: Optional[MessageTemplate] = None
    forgot_password: Optional[MessageTemplate] = None
    update_user_attribute: Optional[MessageTemplate] = None
    verify_user_attribute: Optional[MessageTemplate] = None
    authentication_mfa: Optional[MessageTemplate] = None
    __properties = ["sign_up", "create_user", "resend_code", "forgot_password", "update_user_attribute", "verify_user_attribute", "authentication_mfa"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateNotificationMessagesParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateNotificationMessagesParam:
        """Create an instance of UpdateNotificationMessagesParam from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateNotificationMessagesParam.parse_obj(obj)

        _obj = UpdateNotificationMessagesParam.parse_obj({
