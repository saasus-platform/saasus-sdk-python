...
class UpdateSaasUserPasswordParam(BaseModel):
    ...
    """
    password: StrictStr = Field(..., description="パスワード(password)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateSaasUserPasswordParam:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateSaasUserPasswordParam:
