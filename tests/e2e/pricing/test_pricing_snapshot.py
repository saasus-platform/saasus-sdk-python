"""Pricing API snapshot tests.

JavaScriptのpricing.snapshot.tsを参考にしたスナップショットテスト。
"""
...
from tests.e2e.pricing.stories import get_pricing_stories
from tests.e2e.pricing.state import StateManager
...
class TestPricingSnapshot:
    ...
    def setup_snapshot_mode(self):
        ...
        print("\n🚀 Starting SaaSus Pricing API Snapshot Tests")
        print("=" * 80)
    ...
    def test_all_stories_snapshot(self, test_config, test_logger, sdk_client, coverage_tracker):
        ...
        try:
            ...
            print("✅ All Pricing API E2E snapshot tests completed!")
